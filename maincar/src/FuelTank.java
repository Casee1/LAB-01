...
public class FuelTank
{
    ...
    /**
     * Min fuel level: 0 i.e empty tank
     */
    public static final float LEVEL_MIN = 0f;
    /**
     * Max fuel level: 1 i.e. full tank
     */
    public static final float LEVEL_MAX = 1f;
    /**
     * Default capacity is 60 litres
     */
    public static final float DEFAULT_CAPACITY = 60f;
    /**
     * Create a default capacity fuel tank, filled up
     */
    public FuelTank()
    {
    ...
    public FuelTank(float cap, float level)
    {
        ...
        {
            System.err.println("Invalid capacity  " + cap +
                    " for fuel tank. Adjusted to 60");
            cap = DEFAULT_CAPACITY;
        }
        if (level < LEVEL_MIN || level > LEVEL_MAX)
        {
            System.err.println("Invalid fuel level: " + level +
