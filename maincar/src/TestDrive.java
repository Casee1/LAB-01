...
public class TestDrive
{
    ...
    {
        TestDrive td=new TestDrive(3);
        td.cars[0]=td.createCar("LAMBO",java.awt.Color.YELLOW,700,400,20);
        td.cars[1]=td.createCar("LAMBO",java.awt.Color.YELLOW,700,400,20);
        td.driveCar(td.cars[1]);
        td.driveCar(td.cars[0]);
    ...
    public void start()
    {
        ...
        Car beetle = new Car("Volskwagen Beetle", Color.orange, 80, 160, 10,70,50.0f);
        //Take it for a drive
        System.out.println("Starting beetle test drive!");
        driveCar(beetle);
        //Create a Ferrari
        Car ferrari = new Car("Ferrari Testarosa", Color.red, 300, 280, 30,70,50.0f);
        //Take it for a drive
     ...
     */
    public Car createCar(String brand, Color color, int power, int maxSpeed, int accelerationStep)
    {
        // TODO validate parameters. If wrong, then give message and create a default configured car
        Car c = new Car(brand, color, power, maxSpeed, accelerationStep,70,50.0f);
        return c;
    }
    /**
    ...
    /**
     * Asks for user input for a car identified by carId
    ...
    private void driveCar(Car c)
    {
        ...
        // former contents
        System.out.print("Car is a " + c.getBrandAndModel());
